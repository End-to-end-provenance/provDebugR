...
test_that("just.logical works", {
      variable.results <- debug.variable.type(debug.variable.type(), just.logical=TRUE)
      expect_equal (variable.results$x, "Type did not change")
      expect_equal (variable.results$y, "Type changed")
    })
